...
/**
    ...
    public static void Earl() {
        ...
        JButton text=new JButton("A nobleman ranking above a Viscount and below Marques");
        text.setBounds(500,10,400,30);
        
        JButton ans1=new JButton();
        ans1.setBackground(Color.yellow);
        ans1.setBounds(520,300,50,50);
        ans1.setEnabled(false);
        
        JButton ans2=new JButton();
        ans2.setBackground(Color.yellow);
        ans2.setBounds(600,300,50,50);
        ans2.setEnabled(false);
        
        JButton ans3=new JButton();
        ans3.setBackground(Color.yellow);
        ans3.setBounds(680,300,50,50);
        ans3.setEnabled(false);
        
        JButton ans4=new JButton();
        ans4.setBackground(Color.yellow);
        ans4.setBounds(760,300,50,50);
        ans4.setEnabled(false);
        
        JLabel image=new JLabel();
        image.setBounds(900,350,394,250);
        image.setIcon(new ImageIcon("C:\\Users\\user\\Documents\\NetBeansProjects\\Hangaroo GUI\\src\\hangaroo\\gui\\spongebob.png"));
        ...
        f.add(error4);f.add(image);f.add(next);f.add(panel);f.add(wallpaper);
