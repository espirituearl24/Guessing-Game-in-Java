...
import static hangaroo.gui.Joshua.correct;
import static hangaroo.gui.Joshua.errorctr;
...
public class TheWeeknd {
    ...
    public static void TheWeeknd() {
        
         bgMusic();
        
         JFrame f = new JFrame();
        
        String[] sagot = {"T", "H", "E", "W", "K", "N", "D"};
          ...
          y.addActionListener(new ActionListener(){
              ...
              public void actionPerformed(ActionEvent e){
                  ...
                  if(errorctr==4){
                      ...
                      error3.setBackground(Color.red);
                      error4.setBackground(Color.red);
                      image.setIcon(new ImageIcon("C:\\Users\\user\\Pictures\\Saved Pictures\\walk out.gif"));end();
                      bgMusic();
                  }
        ...
        f.add(error4);f.add(image);f.add(next);f.add(ans5);f.add(ans6);f.add(ans7);f.add(ans8);f.add(ans9);
